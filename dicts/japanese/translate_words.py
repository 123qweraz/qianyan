...
# --- Configuration ---
INPUT_FILE = 'cjdict_sample_words.txt'
OUTPUT_FILE = 'cjdict_sample_trans.txt'
CHECKPOINT_FILE = 'translation_checkpoint.json'
MODEL_NAME = 'granite4.1:3b'  # Updated to the exact name found
BATCH_SIZE = 10               # Slightly larger batch for better context
...
def get_translations_batch(words_list):
    ...
    prompt = f"""
Translate the following list of Japanese words/phrases into English. 
Provide the translations in the exact same order, separated by semicolons. 
